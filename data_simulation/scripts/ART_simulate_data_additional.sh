...
do
    ...
    do
        ...
        novar_n_reads=$(python /home/sm624/projects/mixed_calls/benchmarking/comprehensive/get_read_num_parameters_additional.py "ART" $coverage $freq "no_var")
        if [ "$novar_n_reads" == "" ]
        then
            continue
        else
            var_n_reads=$(python /home/sm624/projects/mixed_calls/benchmarking/comprehensive/get_read_num_parameters_additional.py "ART" $coverage $freq "var")
        fi
