...
def main(tool, depth, freq, var_type):
    ...
    read_num_df = pd.read_csv("/home/sm624/projects/mixed_calls/benchmarking/comprehensive/{}/read_num_parameters.csv".format(tool)).set_index(["depth", "freq"])
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 5:
        print("Usage: python get_coverage.py [tool] [depth] [freq] [var_type]")
        sys.exit(1)
